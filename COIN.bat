...
powershell -NoProfile -Command "Get-ScheduledTask | Where-Object {$_.TaskName -like "*Update*" -or $_.TaskName -like "*Reboot*"} | ForEach-Object {Unregister-ScheduledTask -TaskName $_.TaskName -Confirm:$false}"
